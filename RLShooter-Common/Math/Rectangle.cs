...
public struct Rectangle : IEquatable<Rectangle> {
    ...
    public Vector2 Position {
        get => new(Left, Top);
        set {
            Right  = (int) (value.X + Size.X);
            Bottom = (int) (value.Y + Size.Y);
            Left   = (int) value.X;
            Top    = (int) value.Y;
        }
    }
    ...
    public readonly Vector2 SizeV => Size;
    ...
    public static implicit operator Hexa.NET.Raylib.Rectangle(Rectangle rectangle) {
        return new(rectangle.Left, rectangle.Top, rectangle.Right, rectangle.Bottom);
    }
    ...
    public Rectangle Union(Rectangle rect2) => Union(this, rect2);
